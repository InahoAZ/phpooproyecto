		...
		<div class="panel-body">		
			<form class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
					...
					<div class="col-md-2">
						<input type="text" class="col-md-1 form-control input-sm" id="nombre_cliente" placeholder=""  required>										
					...
					<div class="col-md-2">
						<input type="text" class="form-control input-sm" id="tel1" placeholder="">
					</div>
					<label for="mail" class="col-md-1 control-label">DNI</label>
					<div class="col-md-3">
						<input type="text" class="form-control input-sm" id="mail" placeholder="">
					</div>
				</div>
				<div class="form-group row">							
